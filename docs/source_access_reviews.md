...
- target_lane: `null`
- candidate_lanes: `public_http`
- Rate limit: 기본 1 request / second
...
- Allowed persisted fields for historical/manual import tests: source URL, title, company, location, deadline, structured snapshot
- Failure mode: skip source
